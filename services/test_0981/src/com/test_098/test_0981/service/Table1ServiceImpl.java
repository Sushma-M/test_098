 ...
 * @see Table1
 */
@Service("test_0981.Table1Service")
@Validated
public class Table1ServiceImpl implements Table1Service {
    ...
    @Transactional(value = "test_0981TransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "test_0981TransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "test_0981TransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service test_0981 for table Table1 to {} format", exportType);
