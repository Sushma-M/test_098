...
import com.test_098.adventureworks2012.service.EmployeeDepartmentHistoryService;
 ...
 */
@RestController("AdventureWorks2012.EmployeeDepartmentHistoryController")
@Api(value = "EmployeeDepartmentHistoryController", description = "Exposes APIs to work with EmployeeDepartmentHistory resource.")
@RequestMapping("/AdventureWorks2012/EmployeeDepartmentHistory")
...
@ApiOperation(value = "Returns the EmployeeDepartmentHistory instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDepartmentHistory getEmployeeDepartmentHistory(@RequestParam("businessEntityId") Integer businessEntityId,@RequestParam("departmentId") Short departmentId,@RequestParam("shiftId") Short shiftId,@RequestParam("startDate") Date startDate) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDepartmentHistory editEmployeeDepartmentHistory(@RequestParam("businessEntityId") Integer businessEntityId,@RequestParam("departmentId") Short departmentId,@RequestParam("shiftId") Short shiftId,@RequestParam("startDate") Date startDate, @RequestBody EmployeeDepartmentHistory employeeDepartmentHistory) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployeeDepartmentHistory(@RequestParam("businessEntityId") Integer businessEntityId,@RequestParam("departmentId") Short departmentId,@RequestParam("shiftId") Short shiftId,@RequestParam("startDate") Date startDate) throws EntityNotFoundException {
