...
import com.test_098.adventureworks2012.Shift;
import com.test_098.adventureworks2012.service.ShiftService;
 ...
 * @see Shift
 */
@RestController("AdventureWorks2012.ShiftController")
@Api(value = "ShiftController", description = "Exposes APIs to work with Shift resource.")
@RequestMapping("/AdventureWorks2012/Shift")
public class ShiftController {

    private static final Logger LOGGER = LoggerFactory.getLogger(ShiftController.class);

    @Autowired
	@Qualifier("AdventureWorks2012.ShiftService")
