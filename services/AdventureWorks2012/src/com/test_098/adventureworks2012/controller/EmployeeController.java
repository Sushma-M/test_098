...
import com.test_098.adventureworks2012.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("AdventureWorks2012.EmployeeController")
@Api(value = "EmployeeController", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/AdventureWorks2012/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

    @Autowired
	@Qualifier("AdventureWorks2012.EmployeeService")
...
public Employee createEmployee(@RequestPart("wm_data_json") Employee employee, @RequestPart(value = "organizationNode", required = false) MultipartFile _organizationNode) {
    ...
    public Employee editEmployee(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        Employee newEmployee = WMMultipartUtils.toObject(multipartHttpServletRequest, Employee.class, "AdventureWorks2012");
