...
import com.test_098.adventureworks2012.service.DepartmentService;
 ...
 * @see Department
 */
@RestController("AdventureWorks2012.DepartmentController")
@Api(value = "DepartmentController", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/AdventureWorks2012/Department")
public class DepartmentController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentController.class);

    @Autowired
	@Qualifier("AdventureWorks2012.DepartmentService")
