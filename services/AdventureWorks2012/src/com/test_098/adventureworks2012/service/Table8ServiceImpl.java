 ...
 * @see Table8
 */
@Service("AdventureWorks2012.Table8Service")
@Validated
public class Table8ServiceImpl implements Table8Service {
    ...
    @Autowired
    @Qualifier("AdventureWorks2012.Table8Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AdventureWorks2012 for table Table8 to {} format", exportType);
