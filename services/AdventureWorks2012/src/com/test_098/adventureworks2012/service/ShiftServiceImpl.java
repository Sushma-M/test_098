 ...
 * @see Shift
 */
@Service("AdventureWorks2012.ShiftService")
@Validated
public class ShiftServiceImpl implements ShiftService {
    ...
    @Autowired
    @Qualifier("AdventureWorks2012.ShiftDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AdventureWorks2012 for table Shift to {} format", exportType);
