 ...
 * @see JobCandidate
 */
@Service("AdventureWorks2012.JobCandidateService")
@Validated
public class JobCandidateServiceImpl implements JobCandidateService {
    ...
    @Autowired
    @Qualifier("AdventureWorks2012.JobCandidateDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AdventureWorks2012 for table JobCandidate to {} format", exportType);
